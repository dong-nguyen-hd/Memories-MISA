          ...
          <div class="content-one">
            <div class="block-input">
              <div class="input-fee-name">
                ...
                >
                  <input v-model.trim="fee.feeName" 
                  v-tooltip.top="{trigger:'hover',content: 'Tên khoản thu không được để trống', autoHide: false, classes: 'tooltip-reload'}"
              ...
              <div class="input-fee-group">
                <div class="input-fee-group">
                  ...
                  <div class="input-fee-group-content">
                    <select tabindex="2" v-model.trim="fee.feeGroupId">
                      <option
            ...
            <div class="block-input">
              <div class="input-fee-amount">
                <div class="child-fee-amount-one">
                  ...
                  >
                    <input tabindex="3" 
                    v-tooltip.top="{trigger:'hover',content: 'Giá trị của mức thu phải lớn hơn 0', autoHide: false, classes: 'tooltip-reload'}"
                    type="text" v-model="tempAmount" />
                  </div>
                </div>
            ...
            <div class="block-input">
              <div class="input-fee-range">
                ...
                >
                  <select tabindex="5" 
                  v-model.trim="fee.feeRangeId"
                  v-tooltip.top="{trigger:'hover',content: 'Phạm vi thu không được để trống', autoHide: false, classes: 'tooltip-reload'}"
                  >
                    <option
...
<style scoped src="../style/layout/feeFormInput.css"></style>
<script src="../script/layout/feeFormInput.js"></script>

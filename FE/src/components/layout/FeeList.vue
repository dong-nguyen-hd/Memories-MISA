  ...
  <div class="main-content">
    ...
    <div class="content-upper">
      ...
      <div class="content-right">
        <!-- Delete all -->
        <div
          v-tooltip.top-left="{content: 'Xoá tất cả đối tượng đã chọn', autoHide: false, classes: 'tooltip-reload'}"
...
<style scoped src="../style/layout/feeList.css"></style>
<script src="../script/layout/feeList.js"></script>
